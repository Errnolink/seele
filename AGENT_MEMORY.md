...
- Image resize MUST stay off the main thread. `nativeImage.createFromBuffer` is SYNC and decodes the full-res bitmap — it freezes the Electron main process. Use `sharp` (libvips, off-thread) instead.
